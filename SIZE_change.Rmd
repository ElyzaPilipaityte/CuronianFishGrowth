...
```{r}
pikeperch <- sizedata %>% filter (spp_name_lt=="Starkis") %>% filter (year < 2023)
```
...
Something is wrong with pikeperch 2023 
...
# Species names
species_names <- c("Perca fluviatilis", "Sander lucioperca", "Abramis brama", "Rutilus rutilus")
