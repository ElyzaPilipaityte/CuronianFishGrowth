...
plot1 <- ggplot(df, aes(x = Year, y = Size, color = Group)) +
  ...
  labs(
    ...
    x = "1950                                                                               2020",
    color = "Group",
    caption = "Fish species illustrations \u00A9 Amy Rose Coghlan"
  ) +
  scale_color_manual(values = c("#999933", "#6699CC", "#661100", "#44AA99")) +
  My_theme  +
  theme(legend.position = "none",
        axis.text = element_blank(),
        plot.caption = element_text(size = 22, hjust = 1, color = "gray0"))

 ggsave("grap_abs1.tiff", plot = plot1, units = "mm", 
       width = 350, height = 230, dpi = 300, compression = 'lzw')
...
# Define growth parameters for each Species × Temp
params <- data.frame(
  Species = rep(c("Bream", "Roach", "Perch", "Sander"), each = 2),
  Temp = rep(c("Cool", "Warm"), times = 4),
  Linf = c(60, 54, 49, 45, 44, 27, 70, 140),
  k = c(0.3, 0.4, 0.3, 0.4, 0.3, 0.9, 0.4, 0.2),
  L0 = c(7, 7, 4, 4, 0, 0, 10, 10)
)
...
plot2 <- ggplot(growth_data, aes(x = Age, y = Size, color = Species, linetype = Temp)) +
  geom_line(size = 1.4) +
  labs(x = "Age (years)", y = "Length", title = NULL) +
  scale_color_manual(values = c("Bream" = "#661100", "Roach" = "#6699CC", "Perch" = "#44AA99", "Sander" = "#999933")) +
  ...
  annotate("text", x = 6.5, y = 13, label = "variable growth responses \nto warming among species", size = 9) +
...
plot2 <- ggplot(growth_data, aes(x = Age, y = Size, color = Species, linetype = Temp)) +
  ...
  scale_linetype_manual(
    values = c("Cool" = "solid", "Warm" = "dashed"),
    labels = c("Cool" = "Colder period", "Warm" = "Warmer period")
  ) +
  theme_minimal(base_size = 16) +
  theme(
    legend.title = element_blank(),  # keep this blank, or set name in scale_* if you want a title
...
graph <- plot_grid(plot1, plot2, ncol = 2, align = 'v') 

ggsave("grap_abs.tiff", plot = graph, units = "mm", 
       width = 400, height = 200, dpi = 300, compression = 'lzw')
