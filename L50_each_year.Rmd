...
annotate("text", x = max(combined_sampled_data$year), y = min(combined_sampled_data$predicted_values.x), label = paste0("p < ", significance_level, " in ", significant_p_values, "%"), hjust = 1, vjust = -16.5, size = 5, color = "black") + expand_limits(y = 0) +
   My_theme
```
