...
# Save the plot with larger canvas size and more space for axis labels
ggsave("final_plot_with_x.tiff", plot = final_plot_with_x, units = "mm", 
...
# Save the plot with larger canvas size and more space for axis labels
ggsave("final_plot_with_x2.tiff", plot = final_plot_with_x, units = "mm", 
       width = 300, height = 250, dpi = 300, compression = 'lzw')
```
