...
My_theme <- theme(
  ...
  plot.margin=unit(c(1,2,5,0), 'cm') # top, right, bottom, left
)
...
br <- br + labs(y = NULL, x = NULL) + theme(plot.title = element_text(size = 18, hjust = 0.5))
r <- r + labs(y = NULL, x = NULL) + theme(plot.title = element_text(size = 18, hjust = 0.5))
p <- p + labs(y = NULL, x = NULL) + theme(plot.title = element_text(size = 18, hjust = 0.5))
PP <- PP + labs(y = NULL, x = NULL) + theme(plot.title = element_text(size = 18, hjust = 0.5))
...
ggsave("final_plot_with_x.tiff", units = "mm", width = 230, height = 180, dpi = 300, compression = 'lzw')
